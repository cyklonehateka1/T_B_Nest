...
export class Tip {
  ...
  @Column({
    ...
    type: "text",
    nullable: true,
    comment: "The AI's reasoning/analysis for this tip",
  })
  aiReasoning?: string;
  ...
  @Column({
    ...
    length: 50,
    nullable: true,
    comment: "Which AI model generated this tip",
  })
  ...
  @Column({
    ...
    length: 50,
    nullable: true,
    comment: "Which prompt template version was used",
  })
  ...
  @Column({
    ...
    type: "integer",
    nullable: true,
    comment: "Data quality score at generation time (0-100)",
  })
  ...
  @Column({
    ...
    type: "timestamptz",
    nullable: true,
    comment: "When this tip was auto-generated",
  })
