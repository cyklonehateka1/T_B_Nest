...
@Index("idx_personal_prediction_selections_prediction_id", [
  "personalPrediction",
])
...
export class PersonalPredictionSelection {
  ...
  @JoinColumn({
    name: "personal_prediction_id",
    foreignKeyConstraintName: "fk_personal_prediction_selections_prediction",
  })
  ...
  @JoinColumn({
    name: "match_id",
    foreignKeyConstraintName: "fk_personal_prediction_selections_match",
  })
  match: Match;
