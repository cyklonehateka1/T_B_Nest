...
export class Match {
  ...
  @JoinColumn({ name: 'league_id', foreignKeyConstraintName: 'fk_matches_league' })
  league?: League;

  @ManyToOne(() => Team, { nullable: false })
  @JoinColumn({ name: 'home_team_id', foreignKeyConstraintName: 'fk_matches_home_team' })
  homeTeam: Team;

  @ManyToOne(() => Team, { nullable: false })
  @JoinColumn({ name: 'away_team_id', foreignKeyConstraintName: 'fk_matches_away_team' })
  awayTeam: Team;
