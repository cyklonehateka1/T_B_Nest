...
export class Tipster {
  ...
  @Column({ name: 'successful_tips', type: 'integer', nullable: false, default: 0 })
  successfulTips: number;

  @Column({ name: 'total_earnings', type: 'decimal', precision: 10, scale: 2, nullable: false, default: 0 })
  totalEarnings: number;

  @Column({ name: 'success_rate', type: 'decimal', precision: 5, scale: 2, nullable: false, default: 0 })
  successRate: number;

  @Column({ type: 'decimal', precision: 5, scale: 2, nullable: false, default: 0 })
  rating: number;

  @Column({ name: 'kyc_status', type: 'varchar', length: 20, nullable: true, default: 'not_applied' })
  kycStatus?: string;
  ...
  @Column({ name: 'payout_method', type: 'varchar', length: 50, nullable: true })
  payoutMethod?: string;
