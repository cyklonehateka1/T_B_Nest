...
export class User {
  ...
  // Qualification tracking fields (for pre-tipster predictions)
  // These track a user's performance before they become a tipster
  @Column({
    name: "qualification_total_predictions",
    type: "integer",
    nullable: false,
    default: 0,
  })
  qualificationTotalPredictions: number;

  @Column({
    name: "qualification_correct_predictions",
    type: "integer",
    nullable: false,
    default: 0,
  })
  qualificationCorrectPredictions: number;
  ...
  qualificationScore: number; // Percentage score based on predictions

  @Column({
    name: "qualification_meets_threshold",
    type: "boolean",
    nullable: false,
    default: false,
  })
  qualificationMeetsThreshold: boolean; // True if they meet the threshold (e.g., 10/15 correct)

  @Column({
    name: "qualification_last_updated",
    type: "timestamptz",
    nullable: true,
  })
  qualificationLastUpdated?: Date; // When qualification was last calculated
